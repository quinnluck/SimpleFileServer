...
namespace SimpleFileSystem
{
    public class Drive
    {
        ...
        public Drive(string _name, string _path)
        {
            this.name = _name;
            this.path = _path;
            this.size = 0;
        ...
        /// </summary>
        /// <param name="_textFiles">The children Text files contained in this Drive</param>
        /// <param name="_zipFiles">The children Zip files contained in this Drive</param>
        /// <param name="_folders">The children Folders contained in this Drive</param>
